...
RUN wget https://storage.googleapis.com/kubernetes-release/release/v1.15.11/bin/linux/amd64/hyperkube \
    -O /usr/share/nginx/html/k8s-share/kubernetes-release/release/v1.15.11/bin/linux/amd64/hyperkube
RUN wget https://storage.googleapis.com/kubernetes-release/release/v1.15.11/bin/linux/amd64/kubeadm \
